---
title: Setup
description: Install Alchemy and connect it to your AWS account — SSO or stored access keys locally, environment credentials in CI.
---
...
The first time you run `alchemy deploy` (or `plan`, `dev`,
